...
ActiveRecord::Schema.define(version: 20160822184127) do
  ...
  add_index "interpreters", ["email"], name: "index_interpreters_on_email", unique: true, using: :btree
  add_index "interpreters", ["reset_password_token"], name: "index_interpreters_on_reset_password_token", unique: true, using: :btree
